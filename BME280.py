...
class BME280:
    ...
    lastPressureMeasurement = -100

    TEMPERATURE_PARAM_NAME = "Temperatura"
    RELATIVE_HUMIDITY_PARAM_NAME = "Wilgotność"
    PRESSURE_PARAM_NAME = "Ciśnienie"

    def __init__(self, bus=None, freq=None, sda=None, scl=None, t_mode=2, p_mode=5, h_mode=1, iir=1, address=0x76):
        try:
            if compat_ind >= 1:
                pass
            else:
        ...
        ParameterStorage.addParameter(self.PRESSURE_PARAM_NAME,"hPa")
    ...
    def values(self):
        ...
        return (new_temp, new_press, new_humi)
